...
proglab@proglab:~$ javac Subnet.java
proglab@proglab:~$ java Subnet
Enter the ip address: 192.168.0.140
IP in binary is 11000000101010000000000010001100
Enter the number of addresses: 32
Number of bits required for address = 5
The subnet mask is = 27
Subnet address is = 192.168.0.128
Broadcast address is = 192.168.0.159
proglab@proglab:~$ 
